...
local isLeaderBots = function(msg)
	local var = false;
	if msg.sender_id.user_id == 935728510 or msg.sender_id.user_id == 935728510 then
		var = true;
	end;
	return var;
end;
local isLeaderBots1 = function(user)
	local var = false;
	if user == 935728510 or user == 935728510 then
		var = true;
	end;
	return var;
end;
local is_configure = function(msg)
	local var = false;
	if msg.sender_id.user_id == 935728510 or msg.sender_id.user_id == 935728510 or isLeaderBots(msg) then
		var = true;
	end;
	return var;
end;
